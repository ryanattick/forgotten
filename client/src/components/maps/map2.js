  ...
  componentWillMount() {
    if (this.props.currentPuzzleNum >= 20) {
      ...
      this.setState({
        ...
        completedQuests: ['0'].concat(this.state.levelsRemaining.slice(0, this.props.currentPuzzleNum - 10)),
      ...
      if (this.state.greenclickedQuest) {
        ...
        this.setState({
          ...
          if (this.state.currentQuest === '9') {
            Request.post('/mapData', {level: parseInt('1' + this.state.currentQuest) + 1}, (data) => {
