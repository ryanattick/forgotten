...
item = [
  {
    ...
    solution: 'Catfish',
    story_pop_up: 'You take a breath and try to think back. How did you get here? Where is here? You decide to take things one step at a time. What is your name? As soon as that thought enters your mind you feel a vibration in your pocket',
  ...
  },
  {
    ...
    solution: 'Shadow',
    story_pop_up: 'You were promised a clue, but minutes go by and nothing. You have to get out of here. This room is starting to freak you out. Is it getting smaller? The light is definitely getting dimmer. You look up and frantically glance around the room. What would you find on that desk that you wouldn’t like? You start walking toward it, but whip around when you hear a grinding noise behind you. The bookcase is no longer flush against the concrete wall. The right hand corner is now jutting away at an angle. You turn in a quick circle to get a full view of the room. Someone or something must have moved it. You see nothing suspicious, but your eyes do catch on a simple blue backpack in a corner. You pick it up and it feels empty. Without pausing to check, you stuff as many of the papers from the table as you can into the it. There’s no time. The walls are definitely getting closer to one another and the light is so faint you can hardly see the bookshelf from across the room. You run over to it and push it further away from the wall. Relief fills you as you see a small door comes into view behind it. You put on the backpack and try the knob, but it’s locked. Your heart drops. You’re going to die here. You can’t hear or see the walls move, but every time you look up they’re closer together. You hold out your arms and you can almost touch the walls on either side of you. Far too close. You start kicking the door as hard as you can. You ram your shoulder into it. You’re desperate. A vibration in your pocket stops you and you look down.',
    message_pop_up: '"Careful, you’re going to hurt yourself. Then how would you ever get out of here? You’re going to need all of your strength if you’re going to stay alive. It does look like you’re running short on time. Let me help you out." \n "Check the backpack."',
    pop_up_image_url: null
...
// Q: Find a 10-digit number where the first digit is how many zeros in the number, the second digit is how many 1s in the number etc. until the tenth digit which is how many 9s in the number. A: 6210001000


// [3:54]
// Q: You can only use any letter once, what are the largest and smallest numbers that you could write down in words? A: Largest: FIVE THOUSAND
// Smallest: ZERO or NOUGHT
// Or: MINUS FORTY (allowing negative numbers)


// [3:57]
// Q: Find a number with its letters in alphabetical order.
// Example: "five" has "fiv" in alphabetical order, but not "e". A: Forty
